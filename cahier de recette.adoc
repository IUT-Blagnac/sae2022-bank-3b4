...
^|All_G_COP.2  ^|Rentrer un montant 200 dans le champ "Decouvert autorisé" et 200 dans le champ "Solde" et valider en cliquant "Ajouter" . ^|Le nouveau compte crée a un solde de 200euros et un decouvert autorisé de -200. ^|
 ^|OK
