 ...
 */
public class EmpruntControllerPane {

    private Stage primaryStage;
    private DailyBankState dailyBankState;
    private EmpruntController omcViewController;
     ...
     */
    public EmpruntControllerPane(Stage _parentStage, DailyBankState _dbstate, CompteCourant _cc) {
        this.cc = _cc;
        this.dailyBankState = _dbstate;
        try {
            FXMLLoader loader = new FXMLLoader(
                    EmpruntController.class.getResource("empruntsimulercontroll.fxml"));
            ...
            this.omcViewController.initContext(this.primaryStage, _dbstate);
    ...
    public void simuler() {
        EmpruntManagement cep = new EmpruntManagement(this.primaryStage, this.dailyBankState, getCompteCourant());
