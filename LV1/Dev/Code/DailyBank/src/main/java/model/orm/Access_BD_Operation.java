...
public class Access_BD_Operation {
    ...
    public void insertCredit(int idNumCompte, double montant, String idTypeOp) throws DatabaseConnexionException, DataAccessException {
		try {
			Connection con = LogToDatabase.getConnexion();
			CallableStatement call;
			//on veut reproduire la procédure debit mais avec un credit
