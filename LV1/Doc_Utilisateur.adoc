...
image::valider.png[width=150, alt=Exemple d'image, title=Mon image]
...
image::crediterdebiter.png[width=500, alt=Exemple d'image, title=Mon image] 
...
image::diagrammedeclasse.png[width=500, alt=Exemple d'image, title=Mon image]
